package com.oceylantr.newcomer.kafka;
...
//		props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.sopho.fiyat.eventsourcing.entity.Event");
//		props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.sopho.mikro.eventsourcing.entity.Event");
		
		return new DefaultKafkaConsumerFactory<String, Event>(props, new StringDeserializer(), new JsonDeserializer<>(Event.class, false));
	}
